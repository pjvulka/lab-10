...
class Parameters(BaseModel):
    ...
    Atributes:
        apartments_json_path (str) : ścieżka do pliku json z danymi dot. apartamentów
        tenants_json_path (str) : ścieżka do pliku json z danymi dot. najemców
        transfers_json_path (str) : ścieżka do pliku json z danymi dot. opłat
        bills_json_path (str) : ścieżka do pliku json z danymi o wysokości rachunków
        tenants_blacklist_json_path (str) : ścieżka do pliku json z czarną listą najemców
        apartment_events_json_path (str) : ścieżka do pliku json z wydarzeniami i danymi o ich kosztach
        max_transfer_pln (float) :  maksymalna kwota przelewu w PLN
        max_refund_pln (float) : maksymalna kwota zwrotu w PLN
    """
